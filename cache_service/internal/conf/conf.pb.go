...
func (x *InternalConf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InternalConf) ProtoMessage() {}

func (x *InternalConf) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InternalConf.ProtoReflect.Descriptor instead.
func (*InternalConf) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1}
}

func (x *InternalConf) GetRedis() *Redis {
	if x != nil {
		return x.Redis
	}
	return nil
...
type Redis struct {
	...
	Ring          *Ring                  `protobuf:"bytes,2,opt,name=ring,proto3" json:"ring,omitempty"`
...
type Ring struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Address       map[string]string      `protobuf:"bytes,1,rep,name=address,proto3" json:"address,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Ring) GetAddress() map[string]string {
	if x != nil {
		return x.Address
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"7\n" +
	"\fInternalConf\x12'\n" +
	"\x05redis\x18\x01 \x01(\v2\x11.kratos.api.RedisR\x05redis\"y\n" +
	"\x05Redis\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\tR\x04mode\x12$\n" +
	"\x04ring\x18\x02 \x01(\v2\x10.kratos.api.RingR\x04ring\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\"{\n" +
	"\x04Ring\x127\n" +
	"\aaddress\x18\x01 \x03(\v2\x1d.kratos.api.Ring.AddressEntryR\aaddress\x1a:\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\"Z cache_service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*InternalConf)(nil),        // 1: kratos.api.InternalConf
	(*Redis)(nil),               // 2: kratos.api.Redis
	(*Ring)(nil),                // 3: kratos.api.Ring
	(*Server)(nil),              // 4: kratos.api.Server
	(*Data)(nil),                // 5: kratos.api.Data
	nil,                         // 6: kratos.api.Ring.AddressEntry
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	2,  // 2: kratos.api.InternalConf.redis:type_name -> kratos.api.Redis
	3,  // 3: kratos.api.Redis.ring:type_name -> kratos.api.Ring
	6,  // 4: kratos.api.Ring.address:type_name -> kratos.api.Ring.AddressEntry
