...
// Account domain model (columns mapped with GORM tags)
type Account struct {
...
// Repository contract implemented by the data layer
...
// Usecase orchestrates business logic over the repository
